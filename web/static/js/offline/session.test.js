import { isOfflineSessionTimestampValid, OFFLINE_SESSION_WINDOW_MS, } from "./session.js";
const authenticatedAt = 1000000;
...
if (!isOfflineSessionTimestampValid(authenticatedAt, authenticatedAt + OFFLINE_SESSION_WINDOW_MS - 1)) {
    throw new Error("A session must remain valid before the 48-hour boundary");
}
if (isOfflineSessionTimestampValid(authenticatedAt, authenticatedAt + OFFLINE_SESSION_WINDOW_MS)) {
