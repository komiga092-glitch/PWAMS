...
async function loadFiles(page = 1) {
    ...
    try {
        const result = await request(`/files?page=${page}&page_size=20`);
...
async function deleteFile(id, deleteButton) {
    ...
    try {
        ...
        showAlert(error instanceof Error ? error.message : "Unable to delete file.");
    }
}
